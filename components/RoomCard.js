...
export const RoomCard = ({data}) => {
    ...
    return (
        ...
        <div className="text-gray-100 group relative bg-brand-med-dark border-8 px-6 py-4 border-brand-dark">
            ...
            <span className="bg-brand-green text-brand-dark text-xs px-4 py-2 mt-3 mb-4 inline-block uppercase tracking-wide font-semibold rounded-full border-2 border-gray-400">
             {data.status}
            </span>
